...
│   └── final/               # Dataset consolidado (Parquet)
...
3. **Integracion** por concatenacion de Space_Missions + GCAT y fusion con UCS mediante clave normalizada de nombre
